...
# ---------------------------------------------------------
# Code By GIS Innovation - Ver 1.0.1
# Changelog:
...
class QGISFMEFormAlgorithmAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        try:
            ...
            result = subprocess.run(cmd_list, capture_output=True, text=True, check=False) # check=False to handle errors manually
